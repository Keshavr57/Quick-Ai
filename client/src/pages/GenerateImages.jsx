...
const GenerateImages = () => {
  ...
  if (user?.plan !== 'premium') {
    return <PremiumGate feature="Generate Images" />;
  }
  ...
  const handleDownload = async () => {
    try {
      ...
      link.href = url;
      link.download = `aivora-generated-image-${Date.now()}.png`;
    ...
    <div className='h-full overflow-y-scroll p-6 text-slate-700'>
      <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        <form onSubmit={onSubmitHandler} className='bg-white rounded-xl border border-gray-200 p-6 shadow-md h-fit'>
          ...
          <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00AD25] to-[#04FF50] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer hover:from-[#009922] hover:to-[#03E047] transition-all shadow-md hover:shadow-lg'>
            {
